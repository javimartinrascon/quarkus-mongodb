...
public class EmbeddedMongoConfiguration implements QuarkusTestResourceLifecycleManager {
    private static MongodExecutable MONGO;

    private static final Logger LOGGER = Logger.getLogger(EmbeddedMongoConfiguration.class);
